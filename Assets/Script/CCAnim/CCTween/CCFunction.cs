...
public static class CCFunction {
    ...
    /// 注意 ： 只适用于UI 如要场景物体使用 请使用Transfrom
    /// </summary>
    public static CCAction MoveToX(this MaskableGraphic t, float endx, float time)
    {
    ...
    ///  旋转到指定角度
    /// </summary>
    public static CCAction Rotation(this Transform s, Vector3 endRotation, float time)
    {
